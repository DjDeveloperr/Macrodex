...
enum MacrodexPreviewData {
    static let sampleCwd = "/Users/dj/Developer/Macrodex"
    ...
    static let sampleServer = PreviewServer(
        id: "local",
        name: "DJ's iPhone",
        hostname: "127.0.0.1",
        port: 8390,
    ...
    @MainActor
    static func makeEmptyAppModel() -> AppModel {
    ...
    static func makeThreadSnapshot(
        server: PreviewServer = sampleServer,
        threadId: String,
        preview: String,
        cwd: String,
        model: String,
...
@MainActor
struct MacrodexPreviewScene<Content: View>: View {
    ...
    init(
        ...
        _appModel = State(initialValue: appModel ?? MacrodexPreviewData.makeConversationAppModel())
        _appState = State(initialValue: appState ?? MacrodexPreviewData.makeAppState())
