...
private enum DiffSyntaxLineKind {
    ...
    var foregroundColor: UIColor {
        switch self {
        case .addition:
            return UIColor(MacrodexTheme.success)
        case .deletion:
            return UIColor(MacrodexTheme.danger)
        case .hunk:
            return UIColor(MacrodexTheme.accentStrong)
        case .metadata:
            return UIColor(MacrodexTheme.textSecondary)
        case .context:
            return UIColor(MacrodexTheme.textBody)
        }
    }
    ...
    var backgroundColor: UIColor {
        switch self {
        case .addition:
            return UIColor(MacrodexTheme.success).withAlphaComponent(0.12)
        case .deletion:
            return UIColor(MacrodexTheme.danger).withAlphaComponent(0.12)
        case .hunk:
            return UIColor(MacrodexTheme.accentStrong).withAlphaComponent(0.12)
        case .metadata:
            return UIColor(MacrodexTheme.surface).withAlphaComponent(0.72)
        case .context:
            return UIColor(MacrodexTheme.codeBackground).withAlphaComponent(0.72)
        }
    }
}
