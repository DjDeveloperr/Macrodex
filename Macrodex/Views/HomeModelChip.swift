        ...
        Button {
            ...
            HStack(spacing: 6) {
                ...
                Image(systemName: "cpu")
                    ...
                    .foregroundStyle(disabled ? MacrodexTheme.textMuted : MacrodexTheme.accent)
                Text(selectedModelLabel)
                    .macrodexMonoFont(size: 12, weight: .semibold)
                    .foregroundStyle(disabled ? MacrodexTheme.textSecondary : MacrodexTheme.textPrimary)
                    .lineLimit(1)
                if !reasoningLabel.isEmpty {
                    Text(reasoningLabel)
                        .macrodexMonoFont(size: 11, weight: .regular)
                        .foregroundStyle(MacrodexTheme.textSecondary.opacity(0.85))
                        .lineLimit(1)
                }
