...
enum StandardFoodDatabase {
    static let foods: [StandardFoodItem] = [
        ...
        .init(id: "two-percent-milk", name: "2% milk", aliases: ["2% milk", "2 percent milk", "reduced fat milk"], servingQuantity: 1, servingUnit: "cup", servingWeight: 244, calories: 122, protein: 8, carbs: 12, fat: 4.8, mealHints: ["drink", "breakfast"]),
