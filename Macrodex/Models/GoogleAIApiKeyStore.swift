...
final class GoogleAIApiKeyStore {
    static let shared = GoogleAIApiKeyStore()

    private let service = "com.dj.Macrodex.google-ai-api-key"
    private let account = "default"
    private let envKey = "GOOGLE_API_KEY"
