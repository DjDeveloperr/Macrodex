...
extension Notification.Name {
    static let themeDidChange = Notification.Name("com.macrodex.themeDidChange")
}

/// Thread-safe store for resolved themes, accessible from any isolation context.
/// ThemeManager writes here; MacrodexTheme reads from here.
...
final class ThemeManager {
    ...
    var selectedLightSlug: String {
        get { UserDefaults.standard.string(forKey: "selectedLightTheme") ?? "macrodex-light" }
        set { UserDefaults.standard.set(newValue, forKey: "selectedLightTheme") }
    }

    var selectedDarkSlug: String {
        get { UserDefaults.standard.string(forKey: "selectedDarkTheme") ?? "macrodex-dark" }
    ...
    func syncFontPreference() {
        ...
        shared.set("system", forKey: "fontFamily")
    }
